...
<head>
	...
	<link rel="stylesheet" href="/dashboard/css/dataTables.bootstrap.min.css">
	<!-- Bootstrap social button library -->
	<link rel="stylesheet" href="/dashboard/css/bootstrap-social.css">
	<!-- Bootstrap select -->
	<link rel="stylesheet" href="/dashboard/css/bootstrap-select.css">
	<!-- Bootstrap file input -->
	<link rel="stylesheet" href="/dashboard/css/fileinput.min.css">
	<!-- Awesome Bootstrap checkbox -->
	<link rel="stylesheet" href="/dashboard/css/awesome-bootstrap-checkbox.css">
	<!-- Admin Stye -->
