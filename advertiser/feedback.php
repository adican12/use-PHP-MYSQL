...
<div class="information" id="information">
	 ...
	 <div class="form-content">
			<form id="ad" method="post">
				...
				<button name="submit" type="submit" class="showDemo" style="margin-right:300px;margin-top:10px;"> Upload!</button>
				<button name="submit_one" type="submit" class="showDemo" onclick="changeDetails()" style="margin-right:300px;">Show Demo </button>
			</form>
	</div>
</div>
