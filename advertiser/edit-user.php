	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">Edit User : <?php echo $row['name']; ?></h3>
						<div class="row">
							<div class="col-md-12">
...
<div class="col-sm-4">
<input type="text" name="designation" class="form-control" required value="<?php echo  $row['designation'];?>">
</div>
</div>
...
<div class="col-sm-4">
<input type="number" name="mobileno" class="form-control" required value="<?php echo  $row['mobile'];?>">
</div>
</div>
