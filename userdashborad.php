...
?>
													...
													<div class="stat-panel-title text-uppercase">Edit Profile</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Notification</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">See Coupons</div>
												</div>
											</div>
											<a href="notification.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
